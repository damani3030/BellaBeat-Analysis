...
![](google_capstone_project_bellabeat_files/figure-html/unnamed-chunk-25-1.png)<!-- -->
...
![](google_capstone_project_bellabeat_files/figure-html/unnamed-chunk-27-1.png)<!-- -->
...
![](google_capstone_project_bellabeat_files/figure-html/unnamed-chunk-28-1.png)<!-- -->
...
![](google_capstone_project_bellabeat_files/figure-html/unnamed-chunk-29-1.png)<!-- -->

```r
combined_merge %>% 
  group_by(id) %>% 
  summarize(total_steps_per_id = sum(total_steps))
```

```
## # A tibble: 24 × 2
##            id total_steps_per_id
##         <dbl>              <dbl>
##  1 1503960366             310142
##  2 1644430081              31871
##  3 1844505072              10431
